...
export default class Cable {
  ...
  lookup(channelString) {
    return _.reduce(this._deconstructChannelPath(channelString), function(cable, channelName) {
  ...
  subscribe(host, method) {
    return this._addListener(this._.slots, host, method);
  }

  _addListener(listener, host, method) {
